    ...
    LOOP
        IF model->'params' IS NULL OR model->'params' = '{}'::jsonb THEN
            ...
            defaults := CASE driver
                ...
                WHEN 'codex' THEN '{"temperature": null, "max_tokens": null, "thinking_budget": null}'::jsonb
